  ...
  return (
    <div className="panel-control-left">
      ...
      >
        ...
        <li className="first-list">
          ...
          <div className="collapsible-body">
            <ul className="side-nav-panel">
              ...
              <li>
                <a href="home-store.html">Home Store</a>
              </li>
            </ul>
          </div>
        </li>
        ...
        <li>
          <div className="collapsible-header">
            <i className="fa fa-support"></i>Features{" "}
            <span>
              <i className="fa fa-chevron-right"></i>
            </span>
          </div>
          <div className="collapsible-body">
            <ul className="side-nav-panel">
              ...
              <li>
                <a href="carousel2.html">Carousel 2</a>
              </li>
              <li>
        ...
        <li>
          ...
          <div className="collapsible-body">
            <ul className="side-nav-panel">
              ...
              <li>
                <a href="gallery-card1.html">Gallery Card 1</a>
              </li>
              <li>
                <a href="gallery-card2.html">Gallery Card 2</a>
              </li>
              <li>
                <a href="gallery-card3.html">Gallery Card 3</a>
              </li>
              <li>
                <a href="gallery-circle1.html">Gallery Circle 1</a>
              </li>
              <li>
                <a href="gallery-circle2.html">Gallery Circle 2</a>
              </li>
              <li>
                <a href="gallery-circle3.html">Gallery Circle 3</a>
              </li>
            </ul>
          </div>
        </li>
        <li>
          <div className="collapsible-header">
            <i className="fa fa-th-large"></i>Portfolio{" "}
            <span>
              <i className="fa fa-chevron-right"></i>
            </span>
          </div>
          <div className="collapsible-body">
            <ul className="side-nav-panel">
              ...
              <li>
                <a href="portfolio-card1.html">Portfolio Card 1</a>
              </li>
              <li>
                <a href="portfolio-card2.html">Portfolio Card 2</a>
              </li>
              <li>
                <a href="portfolio-card3.html">Portfolio Card 3</a>
              </li>
              <li>
                <a href="portfolio-circle1.html">Portfolio Circle 1</a>
              </li>
              <li>
                <a href="portfolio-circle2.html">Portfolio Circle 2</a>
              </li>
              <li>
                <a href="portfolio-circle3.html">Portfolio Circle 3</a>
              </li>
            </ul>
          </div>
        </li>
