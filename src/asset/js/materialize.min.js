          ...
          (c.isWindow = function (a) {
            ...
            (c.each = function (a, c, d) {
              ...
              if (d) {
                ...
                for (f in a) if (((e = c.call(a[f], f, a[f])), e === !1)) break;
              return a;
            }),
            ...
            (c.queue = function (a, d, e) {
              ...
              if (a) {
                ...
                var g = c.data(a, d);
                return e
                  ? (!g || c.isArray(e) ? (g = c.data(a, d, f(e))) : g.push(e),
                    g)
                  : g || [];
              }
            }),
      ...
      (function (a) {
        ...
        return (function (a, b, c, d) {
            ...
            for (
              ...
              if (
                ...
                m.each(v.Lists.transforms3D, function (a, b) {
                  ...
                  f.mobileHA &&
                    ((n = !0), delete g(l).transformCache.translate3d),
            ...
            getPropertyValue: function (a, c, e, f) {
                ...
                if (8 >= n) i = m.css(a, c);
                  ...
                  if (
                    ...
                    if (
                      ...
                      var k =
                        a.offsetHeight -
                        (parseFloat(v.getPropertyValue(a, "borderTopWidth")) ||
                          0) -
                        (parseFloat(
                          v.getPropertyValue(a, "borderBottomWidth")
                        ) || 0) -
                        (parseFloat(v.getPropertyValue(a, "paddingTop")) || 0) -
                        (parseFloat(v.getPropertyValue(a, "paddingBottom")) ||
                          0);
                      return e(), k;
                    }
                    if (
                      ...
                      var l =
                        ...
                        (parseFloat(v.getPropertyValue(a, "borderLeftWidth")) ||
                          0) -
                        (parseFloat(
                          v.getPropertyValue(a, "borderRightWidth")
                        ) || 0) -
                        (parseFloat(v.getPropertyValue(a, "paddingLeft")) ||
                          0) -
                        (parseFloat(v.getPropertyValue(a, "paddingRight")) ||
                          0);
                      return e(), l;
                    }
                  }
                  ...
                  (o =
                    ...
                    (i =
                      9 === n && "filter" === c ? o.getPropertyValue(c) : o[c]),
              ...
              if (v.Hooks.registered[c]) {
                var j = c,
                  k = v.Hooks.getRoot(j);
                e === d &&
                  (e = v.getPropertyValue(a, v.Names.prefixCheck(k)[0])),
                ...
                function r() {
                  ...
                  if (e && d)
                    ...
                    t.init(j),
                      ...
                      (i.percentToPxHeight = I.lastPercentToPxHeight =
                        (parseFloat(
                          v.getPropertyValue(j, "height", null, !0)
                        ) || 1) / h),
                      (i.emToPx = I.lastEmToPx =
                        (parseFloat(v.getPropertyValue(j, "paddingLeft")) ||
                          1) / h),
                ...
                if ("scroll" === C) {
                  ...
                  h.container
                    ? p.isWrapped(h.container) || p.isNode(h.container)
                      ? ((h.container = h.container[0] || h.container),
                        ...
                        (A = w + m(f).position()[D.toLowerCase()] + E))
                      : (h.container = null)
                    : ((w =
                        t.State.scrollAnchor[t.State["scrollProperty" + D]]),
                      (z =
                        t.State.scrollAnchor[
                          t.State[
                  ...
                  g(f).tweensContainer &&
                    ...
                    m.each(q, function (a, b) {
                      if (
                        RegExp("^" + v.Lists.colors.join("$|^") + "$").test(a)
                      ) {
                        var c = l(b, !0),
                          e = c[0],
                          f = c[1],
                    ...
                    if (
                      ...
                      ((h.display !== d &&
                        ...
                        h._cacheValues && F && F[K]
                          ? (O === d && (O = F[K].endValue + F[K].unitType),
                            (Q = g(f).rootPropertyValueCache[P]))
                          : v.Hooks.registered[K]
                          ? O === d
                            ? ((Q = v.getPropertyValue(f, P)),
                              (O = v.getPropertyValue(f, K, Q)))
          ...
          return (
            ...
            (a.Velocity = t),
            a !== b &&
              ((a.fn.velocity = w), (a.fn.velocity.defaults = t.defaults)),
    ...
    (V.prototype = {
      ...
      recognize: function (a) {
        ...
        return l(this.options.enable, [this, b])
          ? (this.state & (ib | jb | kb) && (this.state = eb),
            ...
            void (this.state & (fb | gb | hb | jb) && this.tryEmit(b)))
      ...
      j($, Z, {
        ...
        attrTest: function (a) {
          return (
            ...
            (this.state & fb || (!(this.state & fb) && this.directionTest(a)))
          );
        },
        emit: function (a) {
      ...
      j(_, Z, {
        ...
        attrTest: function (a) {
          return (
            ...
            (Math.abs(a.scale - 1) > this.options.threshold || this.state & fb)
          );
        },
        emit: function (a) {
      ...
      j(ba, Z, {
        ...
        attrTest: function (a) {
          return (
            this._super.attrTest.call(this, a) &&
            (Math.abs(a.rotation) > this.options.threshold || this.state & fb)
          );
        },
      }),
      j(ca, Z, {
      ...
      recognize: function (a) {
        ...
        if (!b.stopped) {
          ...
          for (var f = 0; f < d.length; )
            (c = d[f]),
              b.stopped === mb || (e && c != e && !c.canRecognizeWith(e))
                ? c.reset()
                : c.recognize(a),
...
(Vel = jQuery ? jQuery.Velocity : $ ? $.Velocity : Velocity),
    ...
    (a.fn.collapsible = function (b) {
      ...
      return (
        ...
        this.each(function () {
                ...
                .each(function () {
                  a(this).is(":visible") &&
                    a(this).slideUp({
                      ...
                      complete: function () {
                        a(this).css("height", ""),
                          f(a(this).siblings(".collapsible-header"));
                      },
                    });
                });
          }
          ...
          function e(a) {
            b.accordion || "accordion" === k || void 0 === k ? c(a) : d(a),
              f(a);
          }
          function f(a) {
            a.hasClass("active")
              ? "function" == typeof b.onOpen && b.onOpen.call(this, a.parent())
  ...
  (function (a) {
    (a.fn.scrollTo = function (b) {
      return (
        a(this).scrollTop(
          a(this).scrollTop() - a(this).offset().top + a(b).offset().top
        ),
        this
      );
    }),
              ...
              function d() {
                void 0 !== g.data("induration") &&
                  ...
                  void 0 !== g.data("constrainwidth") &&
                    (h.constrain_width = g.data("constrainwidth")),
                ...
                if (
                  (r.is("body") ||
                    ...
                    r[0].scrollWidth > r[0].clientWidth &&
                      (q = r[0].scrollLeft)),
                  f + j.innerWidth() > a(window).width()
                    ? (l = "right")
                    : f - j.innerWidth() + g.innerWidth() < 0 && (l = "left"),
                  k + j.innerHeight() > c)
                )
                ...
                g.unbind("click." + g.attr("id")),
                  g.bind("click." + g.attr("id"), function (b) {
                    i ||
                      (g[0] != b.currentTarget ||
                      g.hasClass("active") ||
                      0 !== a(b.target).closest(".dropdown-content").length
                        ? g.hasClass("active") &&
                          (f(),
                          a(document).unbind(
                            "click." +
  ...
  (function (a) {
            ...
            this.each(function () {
              var e = a(this),
                ...
                g = function () {
                  ...
                  e.hasClass("bottom-sheet")
                    ? e.velocity({ bottom: "-100%", opacity: 0 }, g)
                    : e.velocity(
                ...
                h = function (f) {
                  ...
                  if (
                    ...
                    e.hasClass("bottom-sheet")
                      ...
                      : (a.Velocity.hook(e, "scaleX", 0.7),
                        e.css({ top: c.starting_top }),
                        e.velocity(
                          { top: c.ending_top, opacity: 1, scaleX: "1" },
                          l
                        ));
                  }
                };
              a(document).off(
                ...
                a(document).on(
                  ...
                  function (b) {
                    (c.starting_top =
                      (a(this).offset().top - a(window).scrollTop()) / 1.15),
                      h(a(this)),
                      b.preventDefault();
                  }
                ),
    ...
    a.fn.modal = function (b) {
      return e[b]
        ...
        : "object" != typeof b && b
        ? void a.error("Method " + b + " does not exist on jQuery.modal")
        ...
        function b() {
          ...
          i.velocity("stop", !0),
            ...
            i.velocity(
              ...
              { duration: h, queue: !1, easing: "easeOutQuad" }
            ),
        ...
        if (!a(this).hasClass("initialized")) {
          ...
          i.wrap(j),
            i.on("click", function () {
              ...
              i.css({ position: "absolute", "z-index": 1e3 })
                .data("width", l)
                .data("height", m);
              ...
              var q = 0,
                ...
                u = 0;
              r > s
                ? ((q = m / l), (t = 0.9 * j), (u = 0.9 * j * q))
                : ((q = l / m), (t = 0.9 * k * q), (u = 0.9 * k)),
                          ...
                          i.css({ left: 0, top: 0 }).velocity(
                            {
                              ...
                              left:
                                ...
                                j / 2 -
                                i.parent(".material-placeholder").offset()
                                  .left -
                                t / 2,
                              top:
                                a(document).scrollTop() +
                                k / 2 -
                                i.parent(".material-placeholder").offset().top -
                                u / 2,
                            },
                            {
                              duration: g,
                      ...
                      .velocity(
                        {
                          ...
                          left:
                            a(document).scrollLeft() +
                            j / 2 -
                            i.parent(".material-placeholder").offset().left -
                            t / 2,
                          top:
                            a(document).scrollTop() +
                            k / 2 -
      ...
      return this.each(function (c) {
        function d(c) {
          ...
          c && f.css("display", "block"),
            i > k &&
              k + l > j &&
              f.css("transform", "translate3D(-50%," + o + "px, 0)");
        }
        var e = a(this);
        e.addClass("parallax"),
          e
        ...
        return (
          ...
          this.each(function () {
            ...
            (c = a(f.filter('[href="' + location.hash + '"]'))),
              ...
              e.append('<div class="indicator"></div>');
              ...
              e.on("click", "a", function (m) {
                ...
                if (!a(this).attr("target")) {
                  (g = e.width()),
                    ...
                    void 0 !== d && d.hide(),
                    (c = a(this)),
                    (d = a(Materialize.escapeHash(this.hash))),
                    (f = e.find("li.tab a"));
                  c.position();
                  c.addClass("active");
                  var n = i;
                  (i = f.index(a(this))),
                    ...
                    void 0 !== d &&
                      (d.show(),
                      "function" == typeof b.onShow && b.onShow.call(this, d)),
                    i - n >= 0
                      ? (l.velocity(
                          { right: j(c) },
  ...
  (function (a) {
              ...
              "mouseenter.tooltip": function (a) {
                var c = function () {
                  m(),
                    ...
                    k.velocity("stop"),
                    l.velocity("stop"),
                    k.css({ display: "block", left: "0px", top: "0px" });
                  var a,
                    c,
                    e,
                    g = f.outerWidth(),
    ...
    var b = function (b, c, d, e) {
      ...
      return (
        0 > f
          ? (f = 4)
          : f + d > window.innerWidth && (f -= f + d - window.innerWidth),
        0 > g
          ? (g = 4)
  ...
  (function (a) {
      ...
      init: function (b) {
        ...
        (b = a.extend(c, b)),
          a(this).each(function () {
            ...
            var e;
            b.draggable
              ? ((e = a('<div class="drag-target"></div>').attr(
                  "data-sidenav",
                  c.attr("data-activates")
                )),
                a("body").append(e))
              : (e = a()),
              "left" == b.edge
                ? (d.css("transform", "translateX(-100%)"), e.css({ left: 0 }))
                : (d
              ...
              d.hasClass("fixed") &&
                a(window).resize(function () {
                  window.innerWidth > 992
                    ...
                    : h === !1 &&
                      ("left" === b.edge
                        ? d.css("transform", "translateX(-100%)")
                        : d.css("transform", "translateX(100%)"));
                }),
              b.closeOnClick === !0 &&
                d.on(
                ...
                .bind("pan", function (c) {
                  if ("touch" == c.gesture.pointerType) {
                    ...
                    if (
                      ...
                      e < window.innerWidth - b.menuWidth / 2
                        ? (h = !0)
                        : e >= window.innerWidth - b.menuWidth / 2 && (h = !1);
                      var k = e - b.menuWidth / 2;
                      0 > k && (k = 0),
                        d.css("transform", "translateX(" + k + "px)");
                    }
                    var l;
                    "left" === b.edge
                      ? ((l = e / b.menuWidth),
                      ...
                      : ((l = Math.abs((e - window.innerWidth) / b.menuWidth)),
                        i.velocity(
                          { opacity: l },
                          { duration: 10, queue: !1, easing: "easeOutQuad" }
                        ));
    ...
    a.fn.sideNav = function (c) {
      return b[c]
        ? b[c].apply(this, Array.prototype.slice.call(arguments, 1))
        : "object" != typeof c && c
        ? void a.error("Method " + c + " does not exist on jQuery.sideNav")
        : b.init.apply(this, arguments);
    };
  })(jQuery),
  (function (a) {
        ...
        b.on("scrollSpy:enter", function () {
          ...
          j[0]
            ? (a('a[href="#' + j[0].attr("id") + '"]').removeClass("active"),
              b.data("scrollSpy:id") < j[0].data("scrollSpy:id")
                ? j.unshift(a(this))
                : j.push(a(this)))
            : j.push(a(this)),
  ...
  (function (a) {
    a(document).ready(function () {
      ...
      a(document).on("change", c, function () {
        ...
        (window.validate_field = function (a) {
          ...
          0 === a.val().length && a[0].validity.badInput === !1
            ...
            : a.hasClass("validate") &&
              ((a.is(":valid") && b && c >= d) || (a.is(":valid") && !b)
                ? (a.removeClass("invalid"), a.addClass("valid"))
                : (a.removeClass("valid"), a.addClass("invalid")));
        });
      ...
      e.length ||
        ((e = a('<div class="hiddendiv common"></div>')), a("body").append(e));
      ...
      a(document).on("change", h, function (b) {
        ...
        a(document).on("input mousedown touchstart", h, function (b) {
          var c = a(this).siblings(".thumb"),
            d = a(this).outerWidth();
          c.length <= 0 &&
            ((c = a('<span class="thumb"><span class="value"></span></span>')),
            a(this).after(c)),
            c.find(".value").html(a(this).val()),
            (i = !0),
            ...
            "input" !== b.type &&
              ((g =
                void 0 === b.pageX || null === b.pageX
                  ? b.originalEvent.touches[0].pageX - a(this).offset().left
        ...
        a(document).on("mousemove touchmove", j, function (b) {
          ...
          if (i) {
            ...
            0 > c ? (c = 0) : c > e && (c = e),
              ...
              d.find(".value").html(d.siblings(h).val());
          }
        }),
              ...
              i.find("li:not(.optgroup)").each(function (f) {
                a(this).click(function (g) {
                  if (
                    ...
                    var h = !0;
                    e
                      ? (a('input[type="checkbox"]', this).prop(
                          "checked",
                          function (a, b) {
                            return !b;
                          }
          ...
          this.each(function () {
            ...
            -1 != k && (e = j.eq(k)),
              h.hasClass("fullscreen") ||
                (b.indicators ? h.height(b.height + 40) : h.height(b.height),
                i.height(b.height)),
              ...
              .bind("pan", function (a) {
                if ("touch" === a.gesture.pointerType) {
                  ...
                  ($curr_slide = i.find(".active")),
                    ...
                    4 === b && (c > h.innerWidth() / 2 || -0.65 > d)
                      ? (n = !0)
                      : 2 === b &&
                        (c < (-1 * h.innerWidth()) / 2 || d > 0.65) &&
                        (m = !0);
                  var e;
                  m &&
                    ((e = $curr_slide.next()),
      ...
      (a.fn.material_chip = function (d) {
        ...
        (this.init = function () {
          ...
          e.$el.each(function () {
            var c = a(this),
              d = Materialize.guid();
            (f.data && f.data instanceof Array) || (f.data = []),
              c.data("chips", f.data),
              c.attr("data-index", b),
          ...
          (this.handleEvents = function () {
            ...
            e.$document
              ...
              e.$document
                .off("keydown.chips-add", b.CHIPS + " " + b.INPUT)
                .on("keydown.chips-add", b.CHIPS + " " + b.INPUT, function (c) {
                  ...
                  return 13 === c.which
                    ? (c.preventDefault(),
                      e.addChip({ tag: d.val() }, f),
                      void d.val(""))
                    : (8 !== c.keyCode && 37 !== c.keyCode) ||
                      "" !== d.val() ||
                      !g
                    ? void 0
                    : (e.selectChip(g - 1, f), void d.blur());
                }),
              e.$document
                .off("click.chips-delete", b.CHIPS + " " + b.DELETE)
                .on(
                  "click.chips-delete",
                  b.CHIPS + " " + b.DELETE,
                  function (c) {
          ...
          (this.chips = function (a, b) {
            ...
            d.length &&
              (d.attr("for", b),
              a.data("chips").length && d.addClass("active"));
          }),
          (this.renderChip = function (a) {
            if (a.tag) {
              var b = '<div class="chip">' + a.tag;
              return (
                a.image && (b += ' <img src="' + a.image + '"> '),
          ...
          (this.setPlaceholder = function (a) {
            a.data("chips").length && f.placeholder
              ? a.find("input").prop("placeholder", f.placeholder)
              : !a.data("chips").length &&
                f.secondaryPlaceholder &&
                a.find("input").prop("placeholder", f.secondaryPlaceholder);
          }),
          ...
          (this.addChip = function (b, c) {
            if (e.isValid(c, b)) {
              for (
                var d = e.renderChip(b), f = [], g = c.data("chips"), h = 0;
                h < g.length;
                h++
              )
                f.push(g[h]);
              f.push(b),
                c.data("chips", f),
                a(d).insertBefore(c.find("input")),
                c.trigger("chip.add", b),
                e.setPlaceholder(c);
            }
          }),
          (this.deleteChip = function (a, b) {
            ...
            for (var d = [], f = b.data("chips"), g = 0; g < f.length; g++)
              g !== a && d.push(f[g]);
            b.data("chips", d),
            ...
            .bind("pan", function (d) {
              if ("touch" === d.gesture.pointerType) {
                ...
                e.velocity(
                  ...
                  2 === f &&
                    (g < (-1 * e.innerWidth()) / 2 || h > 0.75) &&
                    (c = !0);
              }
            })
            .bind("panend", function (d) {
              if (
                (Math.abs(d.gesture.deltaX) < a(this).innerWidth() / 2 &&
                  ((c = !1), (b = !1)),
      ...
      window.addEventListener("scroll", function () {
        ...
        setInterval(function () {
          if (b) {
            b = !1;
            for (
              var c = window.pageYOffset + window.innerHeight, d = 0;
              d < a.length;
              d++
            ) {
              var e = a[d],
    ...
    function b(f, g, i, l) {
            ...
            "mousedown click": function (b) {
              ...
              c != y.$root.children()[0] &&
                ...
                "mousedown" != b.type ||
                  ...
                  (b.preventDefault(), y.$root.eq(0).focus()));
            },
          })
          .on({
            focus: function () {
      ...
      function p() {
        ...
        u.hiddenName === !0
          ? ((b = f.name), (f.name = ""))
          : ((b = [
              "string" == typeof u.hiddenPrefix ? u.hiddenPrefix : "",
        ...
        y = (x.prototype = {
          ...
          render: function (a) {
            return (
              a
                ? y.$root.html(m())
                : y.$root.find("." + v.box).html(y.component.nodes(t.open)),
              y.trigger("render")
            );
          },
          stop: function () {
                  ...
                  j
                    ...
                    .on("keydown." + t.id, function (c) {
                      ...
                      27 == d
                        ...
                        : (c.preventDefault(),
                          e
                            ? b._.trigger(y.component.key.go, y, [
                                b._.trigger(e),
                              ])
                            : y.$root
                                .find("." + v.highlighted)
                                .hasClass(v.disabled) ||
                              y
                                .set("select", y.component.item.highlight)
                                .close());
                    })),
                y.trigger("open"));
          },
              ...
              for (e in h)
                (f = h[e]),
                  e in y.component.item &&
                    (void 0 === f && (f = null), y.component.set(e, f, d)),
                  ("select" == e || "clear" == e) &&
                    w
                      .val("clear" == e ? "" : y.get(e, u.format))
                      .trigger("change");
              y.render();
            }
          ...
          get: function (a, c) {
            ...
            if (a in y.component.item) {
              if ("string" == typeof c) {
                ...
                return d
                  ? b._.trigger(y.component.formats.toString, y.component, [
                      c,
                      d,
                    ])
                  : "";
  ...
  (function (a) {
    ...
    (c.prototype.set = function (a, b, c) {
      ...
      return null === b
        ...
        : ((e["enable" == a ? "disable" : "flip" == a ? "enable" : a] = d.queue[
            a
          ]
            .split(" ")
            .map(function (e) {
        ...
        return {
          ...
          toString: function (a, b) {
            ...
            return c.formats
              ...
              .map(function (a) {
                return (
                  f.trigger(c.formats[a], c, [0, b]) || a.replace(/^!/, "")
                );
              })
              .join("");
          },
      ...
      (c.prototype.nodes = function (a) {
        var b = this,
          ...
          o = (function (a, b) {
            ...
            (c.showWeekdaysFull ? c.weekdaysFull : c.weekdaysLetter).slice(0),
            ...
            return (
              ...
              c.selectMonths && void 0 == d
                ? f.node(
                    ...
                    (a ? "" : "disabled") +
                      " " +
                      f.ariaAttr({ controls: b.$node[0].id + "_table" }) +
                      ' title="' +
                      c.labelMonthSelect +
                      '"'
                  )
                              ...
                              item: function (a) {
                                ...
                                var d = i && i.pick == a.pick,
                                  ...
                                  g =
                                    ...
                                    a.pick < m.pick ||
                                    a.pick > n.pick,
                                  o = f.trigger(b.formats.toString, b, [
                                    c.format,
                                    a,
                                  ]);
                                return [
  ...
  (function (a) {
          ...
          this.each(function () {
            function c() {
              "undefined" != typeof window.ontouchstart &&
                (H[0].addEventListener("touchstart", l),
                H[0].addEventListener("touchmove", m),
                H[0].addEventListener("touchend", n)),
            ...
            function g(a) {
              ...
              if (
                ...
                b.full_width
                  ...
                  : ((j =
                      "translateX(" +
                      (H[0].clientWidth - item_width) / 2 +
                      "px) "),
                    (j +=
                      "translateY(" +
                      (H[0].clientHeight - item_width) / 2 +
                      "px)")),
                I)
              ) {
                var k = q % t,
                ...
                l.index() !== k &&
                  ...
                  G.find(".indicator-item").eq(k).addClass("active"));
              }
              for (
                (!b.no_wrap || (q >= 0 && t > q)) &&
                  ((i = o[f(q)]),
                ...
                b.full_width
                  ? ((zTranslation = b.dist),
                    (tweenedOpacity = c === d && 0 > e ? 1 - h : 1))
                  : ((zTranslation = b.dist * (2 * c + h * g)),
                    (tweenedOpacity = 1 - 0.2 * (2 * c + h * g))),
                  (!b.no_wrap || t > q + c) &&
                    ((i = o[f(q + c)]),
                    (i.style[A] =
                      j +
            ...
            function i() {
              ...
              w &&
                ((a = Date.now() - C),
                (c = w * Math.exp(-a / b.time_constant)),
                c > 2 || -2 > c ? (g(x - c), requestAnimationFrame(i)) : g(x));
            }
            function j(c) {
            ...
            function k(a) {
              ...
              b.no_wrap ||
                (0 > c
                  ? Math.abs(c + t) < Math.abs(c) && (c += t)
                  : c > 0 && Math.abs(c - t) < c && (c -= t)),
                0 > c
                  ? H.trigger("carouselNext", [Math.abs(c)])
                  : c > 0 && H.trigger("carouselPrev", [c]);
            }
            function l(a) {
              (r = !0),
                (E = !1),
            ...
            H.addClass("initialized"),
              ...
              ["webkit", "Moz", "O", "ms"].every(function (a) {
                var b = a + "Transform";
                return "undefined" != typeof document.body.style[b]
                  ? ((A = b), !1)
                  : !0;
              }),
              (window.onresize = g),
              ...
              a(this).on("carouselNext", function (a, b) {
                void 0 === b && (b = 1),
                  (x = p + s * b),
                  p !== x &&
                    ((w = x - p), (C = Date.now()), requestAnimationFrame(i));
              }),
    ...
    a.fn.carousel = function (c) {
      return b[c]
        ? b[c].apply(this, Array.prototype.slice.call(arguments, 1))
        : "object" != typeof c && c
        ? void a.error("Method " + c + " does not exist on jQuery.carousel")
        : b.init.apply(this, arguments);
    };
  })(jQuery);
