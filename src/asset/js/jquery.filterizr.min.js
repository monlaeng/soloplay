  ...
  (r.prototype = {
    ...
    fit: function (t) {
      var i,
        ...
        n = t.length,
        o = n > 0 ? t[0].h : 0;
      for (this.root.h = o, i = 0; n > i; i++)
        (e = t[i]),
          (r = this.findNode(this.root, e.w, e.h))
            ? (e.fit = this.splitNode(r, e.w, e.h))
            : (e.fit = this.growDown(e.w, e.h));
    },
    findNode: function (t, i, r) {
      return t.used
        ? this.findNode(t.right, i, r) || this.findNode(t.down, i, r)
        : i <= t.w && r <= t.h
        ? t
        : null;
    },
    splitNode: function (t, i, r) {
      return (
        ...
        (t.right = { x: t.x + i, y: t.y, w: t.w - i, h: r }),
        t
      );
    },
    ...
    (i.fn.filterizr = function () {
      ...
      if (
        (t._fltr ||
          (t._fltr = i.fn.filterizr.prototype.init(
            t.selector,
            "object" == typeof r[0] ? r[0] : void 0
          )),
        "string" == typeof r[0])
      ) {
        if (r[0].lastIndexOf("_") > -1)
          throw new Error("Filterizr error: You cannot call private methods");
        if ("function" != typeof t._fltr[r[0]])
    ...
    (i.fn.filterizr.prototype = {
      init: function (t, r) {
        ...
        return (
          ...
          0 === arguments.length && ((t = e.options.selector), (r = e.options)),
          1 === arguments.length &&
            "object" == typeof arguments[0] &&
            (r = arguments[0]),
          r && e.setOptions(r),
          e.css({ padding: 0, position: "relative" }),
          (e._lastCategory = 0),
          (e._isAnimating = !1),
          (e._isShuffling = !1),
          (e._isSorting = !1),
          (e._mainArray = e._getFiltrItems()),
          (e._subArrays = e._makeSubarrays()),
          (e._activeArray = e._getCollectionByFilter(e.options.filter)),
          (e._toggledCategories = {}),
          (e._typedText = i("input[data-search]").val() || ""),
          (e._uID = "xxxxxxxx-xxxx-4xxx-yxxx-xxxxxxxxxxxx".replace(
            /[xy]/g,
            function (t) {
          ...
          e._setupEvents(),
          e.options.setupControls && e._setupControls(),
      ...
      filter: function (t) {
        ...
        (i.options.filter = t),
          ...
          i._handleFiltering(r),
          i._isSearchActivated() && i.search(i._typedText);
      },
      toggleFilter: function (t) {
        ...
        i.trigger("filteringStart"),
          t &&
            (i._toggledCategories[t]
              ? delete i._toggledCategories[t]
              : (i._toggledCategories[t] = !0)),
          i._multifilterModeOn()
            ? ((r = i._makeMultifilterArray()),
              i._handleFiltering(r),
              i._isSearchActivated() && i.search(i._typedText))
            : (i.filter("all"),
              i._isSearchActivated() && i.search(i._typedText));
      ...
      search: function (t) {
        var i = this,
          r = i._multifilterModeOn()
            ? i._makeMultifilterArray()
            : i._getCollectionByFilter(i.options.filter),
          e = [],
          n = 0;
        ...
        if (e.length > 0) i._handleFiltering(e);
          ...
          for (n = 0; n < i._activeArray.length; n++)
            i._activeArray[n]._filterOut();
      ...
      shuffle: function () {
        ...
        (t._isAnimating = !0),
          ...
          (t._mainArray = t._fisherYatesShuffle(t._mainArray)),
          (t._subArrays = t._makeSubarrays());
        var i = t._multifilterModeOn()
          ? t._makeMultifilterArray()
          : t._getCollectionByFilter(t.options.filter);
      ...
      sort: function (t, i) {
        ...
        (t = t || "domIndex"),
          ...
          (r._isAnimating = !0),
          (r._isSorting = !0),
          r.trigger("sortingStart");
        var e = "domIndex" !== t && "sortData" !== t && "w" !== t && "h" !== t;
        if (e)
          for (var n = 0; n < r._mainArray.length; n++)
            r._mainArray[n][t] = r._mainArray[n].data(t);
        r._mainArray.sort(r._comparator(t, i)),
          (r._subArrays = r._makeSubarrays());
        var o = r._multifilterModeOn()
          ? r._makeMultifilterArray()
          : r._getCollectionByFilter(r.options.filter);
      ...
      setOptions: function (t) {
        ...
        if (
          i._mainArray &&
          (t.animationDuration || t.delay || t.easing || t.delayMode)
        )
          for (r = 0; r < i._mainArray.length; r++)
            i._mainArray[r].css(
              "transition",
              "all " +
                ...
                i.options.easing +
                " " +
                i._mainArray[r]._calcDelay() +
                "ms"
            );
        t.callbacks &&
          (t.callbacks.onFilteringStart ||
            (i.options.callbacks.onFilteringStart = function () {}),
          t.callbacks.onFilteringEnd ||
            (i.options.callbacks.onFilteringEnd = function () {}),
          t.callbacks.onShufflingStart ||
            (i.options.callbacks.onShufflingStart = function () {}),
          t.callbacks.onShufflingEnd ||
            (i.options.callbacks.onShufflingEnd = function () {}),
          t.callbacks.onSortingStart ||
            (i.options.callbacks.onSortingStart = function () {}),
          t.callbacks.onSortingEnd ||
            (i.options.callbacks.onSortingEnd = function () {})),
          i.options.filterInCss.transform ||
            (i.options.filterInCss.transform = "translate3d(0,0,0)"),
          i.options.filterOutCss.transform ||
            (i.options.filterOutCss.transform = "translate3d(0,0,0)");
      },
      ...
      _makeSubarrays: function () {
        ...
        for (r = 0; r < t._mainArray.length; r++)
          if ("object" == typeof t._mainArray[r]._category)
            for (var e = t._mainArray[r]._category.length, n = 0; e > n; n++)
              i[t._mainArray[r]._category[n] - 1].push(t._mainArray[r]);
      ...
      _setupControls: function () {
        ...
        i("*[data-filter]").click(function () {
          ...
          i("*[data-multifilter]").click(function () {
            ...
            "all" === r
              ? ((t._toggledCategories = {}), t.filter("all"))
              : t.toggleFilter(r);
          }),
        ...
        i(t).resize(function () {
          ...
          r
            .on("resizeFiltrContainer", function () {
              r._multifilterModeOn()
                ? r.toggleFilter()
                : r.filter(r.options.filter);
            })
      ...
      _calcItemPositions: function () {
        ...
        if ("packed" === t.options.layout) {
          ...
          for (h.fit(t._activeArray), c = 0; c < e.length; c++)
            _.push({ left: e[c].fit.x, top: e[c].fit.y });
          n = h.root.h;
        }
        if ("horizontal" === t.options.layout)
          ...
          for (c = 1; c <= e.length; c++)
            (l = e[c - 1].outerHeight()), _.push({ left: f, top: u }), (u += l);
          n = u;
      ...
      _handleFiltering: function (t) {
        for (
          var i = this, r = i._getArrayOfUniqueItems(i._activeArray, t), e = 0;
          e < r.length;
          e++
        )
          r[e]._filterOut();
      ...
      _getArrayOfUniqueItems: function (t, i) {
        ...
        for (a = t.length, r = 0; a > r; r++)
          (e = t[r]), e.domIndex in o || n.push(e);
        return n;
      },
  ...
  var e = {
    ...
    _calcDelay: function () {
      var t = this,
        i = 0;
      return (
        "progressive" === t._parent.options.delayMode
          ? (i = t._parent.options.delay * t.domIndex)
          : t.domIndex % 2 === 0 && (i = t._parent.options.delay),
        i
      );
    },
    _getCategory: function () {
      ...
      if ("string" == typeof i) {
        ...
        for (var r = 0; r < i.length; r++) {
          if (isNaN(parseInt(i[r])))
            throw new Error(
              "Filterizr: the value of data-category must be a number, starting from value 1 and increasing."
            );
          parseInt(i[r]) > t._parent._lastCategory &&
            (t._parent._lastCategory = parseInt(i[r]));
        }
    ...
    _onTransitionEnd: function () {
      var t = this;
      t._filteringOut
        ? (i(t).addClass("filteredOut"),
          (t._isFilteredOut = !0),
          (t._filteringOut = !1))
        : t._filteringIn && ((t._isFilteredOut = !1), (t._filteringIn = !1)),
        t._parent._isAnimating &&
          (t._parent._isShuffling
            ? t._parent.trigger("shufflingEnd")
            : t._parent._isSorting
            ? t._parent.trigger("sortingEnd")
            : t._parent.trigger("filteringEnd"),
          (t._parent._isAnimating = !1));
    },
    _filterOut: function () {
      var t = this,
        i = t._parent._makeDeepCopy(t._parent.options.filterOutCss);
      (i.transform +=
        " translate3d(" + t._lastPos.left + "px," + t._lastPos.top + "px, 0)"),
        t.css(i),
